...
正文采用小四号、1.5 倍行距和两字符首行缩进。文献标注示例
\TeX{}Book \cite{knuth1986TeXbook}。这里给出一个脚注示例\footnote{脚注正文采用小五号。}。
...
用于检查在 \verb|\backmatter| 之后调用 \verb|\appendix| 时仍能得到附录编号。
